...
class CategoriaActivoForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ["nombre", "sigla", "descripcion", "activo"]
        widgets = {
...
class EstadoActivoForm(forms.ModelForm):
    ...
    def clean_codigo(self) -> str:
        ...
        queryset = EstadoActivo.objects.filter(codigo=codigo, eliminado=False)
    ...
    def clean_color(self) -> str:
        ...
        try:
            ...
            raise ValidationError(
                "El color contiene caracteres hexadecimales inválidos."
            )
    ...
    class Meta:
        ...
        widgets = {
            ...
            "codigo_barras": forms.TextInput(
                attrs={
                    "class": "form-control",
                    "placeholder": "Dejar vacío para auto-generar desde código",
                }
            ),
...
class TipoMovimientoActivoForm(forms.ModelForm):
    ...
    def clean_codigo(self) -> str:
        ...
        queryset = TipoMovimientoActivo.objects.filter(codigo=codigo, eliminado=False)
...
class MovimientoActivoForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            "activo": forms.Select(attrs={"class": "form-select", "id": "id_activo"}),
            "estado_nuevo": forms.Select(attrs={"class": "form-select"}),
            "ubicacion_destino": forms.Select(attrs={"class": "form-select"}),
            "taller": forms.Select(attrs={"class": "form-select"}),
            "responsable": forms.Select(attrs={"class": "form-select"}),
            "proveniencia": forms.Select(attrs={"class": "form-select"}),
        ...
        widgets = {
            ...
            "descripcion": forms.Textarea(
                attrs={
                    "class": "form-control",
                    "rows": 3,
                    "placeholder": "Descripción de la proveniencia...",
                }
            ),
            "activo": forms.CheckboxInput(attrs={"class": "form-check-input"}),
        }
