...
class UserCreateForm(forms.ModelForm):
    ...
    nombres = forms.CharField(
        ...
        widget=forms.TextInput(
            attrs={"class": "form-control", "placeholder": "Ingrese los nombres"}
        ),
    )
...
class UserUpdateForm(forms.ModelForm):
    ...
    talla = forms.CharField(
        ...
        required=False,
        widget=forms.TextInput(
            attrs={"class": "form-control", "placeholder": "XS, S, M, L, XL…"}
        ),
    )
    numero_zapato = forms.CharField(
        label="N° Zapato",
    ...
    pin = forms.CharField(
        ...
        widget=forms.PasswordInput(
            attrs={
                "class": "form-control",
                "placeholder": "4 dígitos (vacío = sin cambio)",
                "maxlength": "4",
                "pattern": "[0-9]{4}",
                "inputmode": "numeric",
            }
    ...
    class Meta:
        ...
        widgets = {
            "name": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "Nombre del rol"}
            ),
        }
        labels = {
            "name": "Nombre del Rol",
...
class UserFilterForm(forms.Form):
    ...
    is_staff = forms.TypedChoiceField(
        required=False,
        coerce=lambda x: x == "True",
        choices=[("", "Todos"), ("True", "Staff"), ("False", "No Staff")],
        widget=forms.Select(attrs={"class": "form-select"}),
        label="Es Staff",
    )
...
class PermissionForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "codename": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "Ej: aprobar_solicitud"}
            ),
        }
        labels = {
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["content_type"].queryset = ContentType.objects.all().order_by(
            "app_label", "model"
        )
    ...
    def clean_codename(self):
        ...
        if not codename.replace("_", "").isalnum():
            raise forms.ValidationError(
                "El código del permiso solo puede contener letras, números y guiones bajos."
            )
        return codename
    ...
    class Meta:
        ...
        widgets = {
            ...
            "ubicacion": forms.TextInput(
                attrs={
                    "class": "form-control",
                    "placeholder": "Ubicación física del taller",
                }
            ),
    ...
    class Meta:
        ...
        widgets = {
            ...
            "talla": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "Ej: M, L, XL"}
            ),
            "numero_zapato": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "Ej: 42, 43"}
            ),
        }
        labels = {
